                            ...
                            <div class="-m-2">
                              <div class="mx-auto">
                                <div class="relative">
                                  ...
                                  <input type="text" value="{{ ($owner->name) }}" id="name" name="name" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                              ...
                              <div class="mx-auto">
                                <div class="relative">
                                  ...
                                  <input type="password" id="email" name="password" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                              ...
                              <div class="p-2 w-full mt-4 flex justify-around" >
                                <button type="botton" onclick="location.href='{{ route('admin.owners.index') }}'"class=" text-white bg-gray-400 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">戻る</button>
